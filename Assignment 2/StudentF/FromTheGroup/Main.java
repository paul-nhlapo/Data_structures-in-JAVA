public class Main {
    ...
    public static void task2() {
        ...
        try {
            ...
            System.out.println("\t\tTESTING NON-TREAP OPERATINS:");
            System.out.println("updates: " + db.countOccurences("Session", "Sem 1"));
            db.updateAllWhere("Session", "Sem 1", "Finished");
            System.out.println();


            System.out.println("removals of 'sem 2': " + db.countOccurences("Session", "Sem 2"));
            String[][] temp = db.removeAllWhere("Session", "Sem 2");
            ...
            System.out.println("updates of '1': " + db.countOccurences("Year", "1"));
            temp = db.updateAllWhere("Year", "1", "shaun");
            ...
            System.out.println("finds of '1': " + db.countOccurences("Year", "1"));
            temp = db.findAllWhere("Year", "1");
            System.out.println("Should be zero:" + temp.length);

            System.out.println("finds of '2': " + db.countOccurences("Year", "2"));
            temp = db.findAllWhere("Year", "2");
            ...
            System.out.println("\t\tTESTING TREAP OPERATINS:");
            System.out.println("updates: " + db.countOccurences("Module Code", "COS110"));
            db.updateAllWhere("Module Code", "COS110", "Finished");
            System.out.println();


            System.out.println("removals of 'COS212': " + db.countOccurences("Module Code", "COS212"));
            temp = db.removeAllWhere("Module Code", "COS212");
            ...
            System.out.println("updates of 'COS210': " + db.countOccurences("Module Code", "COS210"));
            temp = db.updateAllWhere("Module Code", "COS210", "shaun");
            ...
            System.out.println("finds of 'FSK700': " + db.countOccurences("Module Code", "FSK700"));
            temp = db.findAllWhere("Module Code", "FSK700");
            ...
            // Test expection
            String p[] = {"PHY356",	"Electronics, electromagnetism and quantum mechanics 356", "36",	"3", "Finished"};
            db.insert(p);
        ...
        System.out.println(db.indexes[2]);
        System.out.println(db.indexes[3]);
        System.out.println(db.indexes[4]);
