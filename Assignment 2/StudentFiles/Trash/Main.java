public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("-------------------------------------------------------");
        // CountMethod();// This works for me!
        // FindMethod();// This one does not work for me!
        UpdateMethod();// This one does not work for me!
        // RemoveMethod();// This one also does not work for me!
        // TestingThe_AllWhere_Methods();// This function does not work for me!
    }
